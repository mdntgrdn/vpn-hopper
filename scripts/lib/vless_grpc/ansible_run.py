#!/usr/bin/env python3
"""Run an ansible/roles/vless_grpc playbook for a chain (shared chain inventory)."""
...
ROLE_PLAYBOOK_DIR = REPO_ROOT / "ansible" / "roles" / "vless_grpc"
...
def run_vless_grpc_playbook(
    playbook_name: str, chain: str, *, extra_vars: dict | None = None
) -> int:
