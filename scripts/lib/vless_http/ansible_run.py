#!/usr/bin/env python3
"""Run an ansible/roles/vless_http playbook for a chain (shared chain inventory)."""
...
ROLE_PLAYBOOK_DIR = REPO_ROOT / "ansible" / "roles" / "vless_http"
